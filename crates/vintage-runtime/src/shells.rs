...
mod tests {
    use super::{
        ...
        resolve_shell, zsh_agent_arguments, ShellDescriptor, ShellDetectionInput, ShellKind,
        SHELL_ID_UNIX_BASH, SHELL_ID_UNIX_BASH_FAST, SHELL_ID_UNIX_DEFAULT, SHELL_ID_UNIX_ZSH_FAST,
    ...
    #[cfg(unix)]
    use super::{resolve_custom_shell, validate_shell_executable};
